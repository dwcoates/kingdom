(function ()
{
    ...
    function updateEngine()
    {
        function eval_pos()
        {
            ...
            engine.send("fetch json search", formatOutput);
        }
