    ...
    function updateJsonOutput()
    {
        ...
        renderjson.set_replacer(function(k,v) {
            ...
            var obj_from_dom = function (el) {
                if (typeof(el) == "number") return "FUCK"; // Capture NaNs and Infinity
            ...
            if (typeof(v) == "number") return "FUCK"; // Capture NaNs and Infinity
