(function ()
{
    ...
    function updateEngine()
    {
        function eval_pos()
        {
            ...
            // simplified
            evaler.send("go depth " + eval_depth);
        }
    ...
    function bitboardToArray(bb)
    {
        var bb2 = bb.toString(2),
            arr = [];
        alert(bb2);
    ...
    function init()
    {
        ...
        var array = bitboardToArray(4294966271);
